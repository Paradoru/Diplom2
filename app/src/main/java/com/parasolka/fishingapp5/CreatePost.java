...
public class CreatePost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(Intent.createChooser(gallery, "Выберите изображение"), PICK_IMAGE);
            }
        });
    ...
    public void upload(Uri uri) {
        if (uri != null) {
            ...
            fileRef.putFile(uri)
                    ...
                    .addOnFailureListener(e -> Toast.makeText(CreatePost.this, "Ошибка при загрузке изображения", Toast.LENGTH_SHORT).show());
        } else {
            uploaddata(); // If no image is selected, proceed to upload data directly
        }
    }
    ...
    private void uploaddata() {
        ...
        if (a1 == null || a1.isEmpty() || a2 == null || a2.isEmpty()) {
            Toast.makeText(CreatePost.this, "Пожалуйста, дополните информацию о себе в профиле (аватарка и имя)", Toast.LENGTH_SHORT).show();
        ...
        firebaseDatabase.getReference().child("posts").child(postId).setValue(u)
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        Toast.makeText(CreatePost.this, "Ваш пост в онлайне", Toast.LENGTH_LONG).show();
                        finish();
                        Intent i = new Intent(CreatePost.this, videoimageplayer.class);
                        startActivity(i);
                    } else {
                        Toast.makeText(CreatePost.this, "Ошибка при загрузке поста", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
