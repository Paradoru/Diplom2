...
public class MyAdapter5 extends RecyclerView.Adapter<productviewholder5> {
    ...
    @Override
    public productviewholder5 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mView2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.your_videopost_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull productviewholder5 holder, int position) {
        ...
        holder.mccard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ConnectivityManager manager = (ConnectivityManager) pcontext5.getSystemService(Context.CONNECTIVITY_SERVICE);
