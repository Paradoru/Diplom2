...
import com.parasolka.fishingapp5.Friends;
import com.parasolka.fishingapp5.MainActivity;
import com.parasolka.fishingapp5.MapsActivity;
import com.parasolka.fishingapp5.Message;
import com.parasolka.fishingapp5.R;
import com.parasolka.fishingapp5.userinfo;
import com.parasolka.fishingapp5.ProfileActivity;
import com.parasolka.fishingapp5.VideoMessage;
import com.parasolka.fishingapp5.YourPost;
import com.parasolka.fishingapp5.YourVideoPost;
...
public class fragment3 extends Fragment {
    ...
    ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        acc.child("users").child(FirebaseAuth.getInstance().getUid()).addValueEventListener(new ValueEventListener() {@Override
        ...
        btn8 =(Button) view.findViewById(R.id.button12);
        btn8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NetworkInfo activenetwork = manager.getActiveNetworkInfo();
                if(null!=activenetwork){
                    Intent i7 = new Intent(getActivity(), MapsActivity.class);
                    startActivity(i7);
                }
                else
                {
